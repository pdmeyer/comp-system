...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 309.0, 106.0, 57.0, 29.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 188.0, 27.0, 69.5, 18.0 ],
					"text" : "retrig interval:",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 202.5, 49.0, 55.0, 18.0 ],
					"text" : "output vel:",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 7.5, 48.0, 34.0, 18.0 ],
					"text" : "rate",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 7.5, 26.0, 34.0, 18.0 ],
					"text" : "count",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 90.5, 48.0, 54.0, 18.0 ],
					"text" : "dest. vel",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 259.0, 48.0, 34.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 253.0, 106.0, 46.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 259.0, 26.0, 34.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 253.0, 77.0, 130.0, 22.0 ],
					"text" : "j.receive metro-interval"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 144.0, 48.0, 34.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 93.0, 26.0, 49.0, 18.0 ],
					"text" : "vel ramp",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 144.0, 25.0, 34.0, 20.0 ],
					"rounded" : 4.0,
					"text" : "Off",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 43.5, 48.0, 34.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 43.5, 26.0, 34.0, 20.0 ]
				}
