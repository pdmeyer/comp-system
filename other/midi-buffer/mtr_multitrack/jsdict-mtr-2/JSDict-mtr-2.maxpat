...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 420.0, 287.0, 518.0, 418.0 ]
				}

			}
, 			{
				"box" : 				{
					"filename" : "mtr-visualizer.js",
					"id" : "obj-25",
					"maxclass" : "jsui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 43.0, 426.38422891497612, 362.0, 188.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 78.856588006019592, 306.730164170265198, 24.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 78.856588006019592, 343.939467072486877, 73.0, 22.0 ],
					"text" : "showinfo $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 151.0, 146.5, 121.0, 51.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 24.0, 15.0, 449.0, 38.0 ],
					"text" : "The JS-mtr connection - Part 2",
					"underline" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 160.33720850944519, 365.063498020172119, 251.0, 37.0 ],
					"text" : "Use jsui to display the contents of the mtr dictionary. Click 'open' to see the code."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 115.33720850944519, 372.563498020172119, 35.0, 22.0 ],
					"text" : "open"
				}
...
, 						{
							"events" : [ 								{
									"time" : 1401.980871997773647,
									"message" : "list",
									"args" : [ 1, 2, 3, 4, 5, 6, 7, 8 ]
								}
, 								{
									"time" : 521.7218909971416,
									"message" : "list",
									"args" : [ 5, 10, 15, 20, 25 ]
								}
, 								{
									"time" : 938.14139100164175,
									"message" : "list",
									"args" : [ 5, 10, 15 ]
								}
, 								{
									"time" : 4121.381390001624823,
									"message" : "list",
									"args" : [ 5, 10, 15, 20, 25 ]
								}
 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-25", 0 ],
					"midpoints" : [ 52.5, 368.143616914749146, 52.5, 368.143616914749146 ],
					"order" : 1,
					"source" : [ "obj-2", 0 ]
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "mtr-visualizer.js",
				"bootpath" : "~/Projects/js-mtr/jsdict-mtr-2",
				"patcherrelativepath" : ".",
				"type" : "TEXT",
				"implicit" : 1
			}
