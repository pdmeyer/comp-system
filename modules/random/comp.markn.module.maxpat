...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 130.0, 101.53125, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 12.0, 172.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					"annotation" : "generate a gate sequence from a first-order markov chain",
					"id" : "obj-1",
					"maxclass" : "newobj",
					"numinlets" : 2,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.0, 141.0, 164.0, 22.0 ],
					"text" : "comp.markn.model #1"
				}
